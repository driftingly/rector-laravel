...
return static function (RectorConfig $rectorConfig): void {
    ...
    $rectorConfig->ruleWithConfiguration(FactoryDefinitionRector::class, [
        'RectorLaravel\Tests\Rector\Namespace_\FactoryDefinitionRector\Fixture\Model',
        'App\User',
        'RectorLaravel\Tests\Rector\Namespace_\FactoryDefinitionRector\Fixture\Account',
