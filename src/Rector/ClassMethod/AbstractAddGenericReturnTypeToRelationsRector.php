...
abstract class AbstractAddGenericReturnTypeToRelationsRector extends AbstractRector implements ComposerPackageConstraintInterface
{
    ...
    /**
     * Whether the installed Laravel version uses the `$this`-based generic format
     * (Illuminate\Database\Eloquent\Relations 11.15+).
     */
    abstract protected function shouldUseNewGenerics(): bool;

    /**
     * Whether the installed Laravel version adds the Pivot generic to BelongsToMany (12.3+).
     */
    abstract protected function shouldUsePivotGeneric(): bool;
