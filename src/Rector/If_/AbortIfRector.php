    ...
    public function refactor(Node $node): ?Node
    {
        ...
        if (
            ...
            if ($condition instanceof BooleanNot) {
                ...
                $funcCall = new FuncCall(new Name('abort_unless'), array_merge([new Arg($condition->expr)], $abortCall->args));
            } else {
                // Create a new throw_if function call
                $funcCall = new FuncCall(new Name('abort_if'), array_merge([new Arg($condition)], $abortCall->args));
            }
