...
final class LaravelSetList
{
     ...
     * @var string
     */
    public const LARAVEL_130 = __DIR__ . '/../../config/sets/laravel130.php';

    /**
     * @var string
     */
    public const LARAVEL_130_WITHOUT_ATTRIBUTES = __DIR__ . '/../../config/sets/laravel130-without-attributes.php';
     ...
     * @var string
     */
    public const LARAVEL_FACTORIES = __DIR__ . '/../../config/sets/laravel-factories.php';
     ...
     * @var string
     */
    public const LARAVEL_TESTING = __DIR__ . '/../../config/sets/laravel-testing.php';

    /**
     * @var string
     */
    public const LARAVEL_TYPE_DECLARATIONS = __DIR__ . '/../../config/sets/laravel-type-declarations.php';

    /**
     * @var string
     */
    public const LUMEN = __DIR__ . '/../../config/sets/lumen.php';
}
